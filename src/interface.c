...
create_app1 (void)
{
  ...
  button2 =
    gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				...
				_("Abrir archivo"), NULL, tmp_toolbar_icon,
				NULL, NULL);
  ...
  button3 =
    gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				...
				_("Guardar archivo"), NULL, tmp_toolbar_icon,
				NULL, NULL);
  ...
  gtk_object_set_data_full (GTK_OBJECT (app1), "averaging_spin",
			    averaging_spin,
			    (GtkDestroyNotify) gtk_widget_unref);
  ...
  node_radius_slider =
    gtk_hscale_new (GTK_ADJUSTMENT
		    (gtk_adjustment_new (3, 0, 5, 0.25, 1, 0)));
  gtk_widget_ref (node_radius_slider);
  gtk_object_set_data_full (GTK_OBJECT (app1), "node_radius_slider",
			    node_radius_slider,
			    (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (app1), "link_width_slider",
			    link_width_slider,
			    (GtkDestroyNotify) gtk_widget_unref);
