...
create_diag_pref (void)
{
  ...
  link_width_slider = gtk_hscale_new (GTK_ADJUSTMENT (gtk_adjustment_new (3, -4, 1, 0.25, 1, 0)));
  ...
  font_button = gtk_button_new_with_label (_ ("Click to set"));
...
create_fontselectiondialog1 (void)
{
  ...
  fontselectiondialog1 = gtk_font_selection_dialog_new (_ ("Seleccione Fuente"));
