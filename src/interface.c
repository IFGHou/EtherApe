...
create_diag_pref (void)
{
  ...
  node_radius_slider = gtk_hscale_new (GTK_ADJUSTMENT (gtk_adjustment_new (-2, -4, 1, 0.25, 1, 0)));
  ...
  gtk_object_set_data_full (GTK_OBJECT (diag_pref), "font_button", font_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (diag_pref), "combo_entry1", combo_entry1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (diag_pref), "filter_gnome_entry", filter_gnome_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook1), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook1), 1), label29);
  ...
  gtk_object_set_data_full (GTK_OBJECT (diag_pref), "save_pref_button", save_pref_button,
                            (GtkDestroyNotify) gtk_widget_unref);
...
create_window1 (void)
{
  ...
  gtk_widget_ref (filter_entry);
  gtk_object_set_data_full (GTK_OBJECT (window1), "filter_entry", filter_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (filter_entry);
