...
static hashether_t *
add_eth_name (u_char * addr, u_char * name)
{
  hashether_t *tp;
...
static hashipxnet_t *
add_ipxnet_name (u_int addr, u_char * name)
{
  hashipxnet_t *tp;
...
static u_char *
ipxnet_name_lookup (const u_int addr)
{
  hashipxnet_t *tp;
  hashipxnet_t **table = ipxnet_table;
  ipxnet_t *ipxnet;
 ...
 */
u_char *
get_ether_name_if_known (const u_char * addr)
{
  hashether_t *tp;
  hashether_t **table = eth_table;
  int i, j;
